...
#[Route(
    name: 'wexample_design_system_generic_overlays_',
    path: AbstractDesignSystemController::CONTROLLER_BASE_ROUTE . '/generic/overlays/',
)]
#[TemplateBasedRoutes]
final class OverlaysController extends AbstractDesignSystemGenericController
{
